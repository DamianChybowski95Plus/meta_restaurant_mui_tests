    ...
    return (
        <Sheet {...FooterSheet}>
            <Stack {...FooterContainer} direction={ isScreenXs ? "column" : "row"}>
                ...
                <Sheet {...FooterItem } variant="soft"><Stack {...FooterStack}><AspectRatio sx={{height:"100%", width:"100%"}}><img alt="Enjoy our little lemon sandwitch" src={FooterImg}/></AspectRatio></Stack></Sheet>
