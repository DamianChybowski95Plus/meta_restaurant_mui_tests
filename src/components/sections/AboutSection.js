    ...
    return(
        <Sheet {...AboutSheet}>
            <Box {...GridContainer} >
                ...
                <AspectRatio {...AspectRatioImg1}><img alt="Lemon Dessert" src={LemonDessertImg}/></AspectRatio>
                <AspectRatio {...AspectRatioImg2}><img alt="Greek Salad" src={GreekSaladImg}/></AspectRatio>
            </Box>
        </Sheet>
    )
}